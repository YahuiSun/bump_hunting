...
1) DBLP_1094k_keywords.txt: The items in each line are: AuthorName, his or her keywords (there are some AuthorNames using non-ascii characters, such as "Zuzana Kom&iacute;nkov&aacute; Oplatkov&aacute;". By putting such names in the search box of DBLP, https://dblp.uni-trier.de/, DBLP will return the more readable format of these names, such as "Zuzana Komínková Oplatková").
